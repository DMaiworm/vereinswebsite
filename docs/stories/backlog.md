...
| [S-013](S-013-topnav-dropdown-regression.md) | TopNav-Regression: Abteilungs- und Kurs-Dropdown vermischt statt getrennt, Wortmarke kollidiert mit umbrechendem departmentLabel | superseded (siehe S-014) | components/shared/layout/BaseNav.tsx |
| [S-014](S-014-topnav-neuausrichtung.md) | TopNav-Neuausrichtung: ein globales Abteilungen-Dropdown, Kurse direkt inline in der Nav (Overflow-Dropdown erst ab 5 Kursen), keine Intrapage-Deko auf Kurs-Unterseiten | review | components/shared/layout/BaseNav.tsx, 15× app/(dept)/*/page.tsx |
| [S-015](S-015-mobile-hero-headline-clipping.md) | Mobile: Hero-Headlines abgeschnitten statt umgebrochen (Gesundheitssport, Kinderturnen, Sponsoren, JFV, Vorstand) | ready | components/shared/sections/AbteilungHero.tsx, 5× app/(dept)/*/page.tsx |
| [S-016](S-016-mobile-card-grid-overflow.md) | Mobile: 2-spaltige Karten-Grids erzwingen horizontalen Overflow (Fußball-/Tischtennis-Trainerstab, Kinderturnen-Kursplan-Badges) | ready | components/fussball/StaffSection.tsx, components/tischtennis/TrainerSection.tsx, app/(dept)/kinderturnen/page.tsx |
| [S-017](S-017-kids-in-bewegung-section-overlap.md) | Mobile: Gruppen-Überschriften überlappen Hero/Infokarten auf Kids-in-Bewegung | ready | app/(dept)/kids-in-bewegung/page.tsx |
| [S-018](S-018-sponsorband-mobile-logo-clipping.md) | Mobile: SponsorBand schneidet zweites Partner-Logo ab (sitewide, ~30 Seiten) | ready | components/shared/layout/SponsorBand.tsx |
