        ...
        <section className="relative h-[716px] min-h-[500px] flex items-center overflow-hidden">
          <div className="absolute inset-0">
            ...
            <img
              ...
              alt="Woman practicing mindful pilates movements in a bright airy studio with floor-to-ceiling windows and soft morning light"
              src="https://upload.wikimedia.org/wikipedia/commons/9/91/Pilates_01.jpg"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/50 to-transparent z-10"></div>
          </div>
          <div className="relative z-20 max-w-[1200px] mx-auto px-6 w-full">
            <div className="max-w-2xl text-white">
              <span className="inline-block px-4 py-1 bg-secondary-container text-on-secondary-fixed rounded-full text-label-lg mb-6">MIND &amp; BODY</span>
              <h1 className="text-display-lg font-display-lg mb-4 text-white">Pilates &amp; BodyART</h1>
              <p className="text-body-lg mb-8 opacity-90">Kraft, Flexibilität und innere Balance. Erleben Sie die Verbindung von funktionalem Training und bewusster Achtsamkeit.</p>
          ...
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-8 border border-surface-container-high rounded-xl shadow-sm flex items-start gap-4 transition-all hover:shadow-md">
              ...
              <div>
                ...
                <p className="text-on-surface-variant font-body-md">Montags, 18:30 – 19:30 Uhr</p>
              </div>
            </div>
            <div className="bg-white p-8 border border-surface-container-high rounded-xl shadow-sm flex items-start gap-4 transition-all hover:shadow-md">
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
              ...
              <div className="md:col-span-3 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                ...
                <h3 className="text-headline-md mb-4">Core Training</h3>
                <p className="text-on-surface-variant">Das &quot;Powerhouse&quot; steht im Mittelpunkt. Gezielte Übungen für Bauch, Rücken und Beckenboden schaffen Stabilität von innen heraus.</p>
              </div>
              {/* Flow Movements */}
              <div className="md:col-span-3 bg-primary-container text-white p-8 rounded-xl transition-transform hover:-translate-y-1">
                ...
                <h3 className="text-headline-md mb-4">Flow Movements</h3>
                <p className="opacity-80">Fließende Bewegungsabfolgen aus dem BodyART fördern die Dynamik und verbinden Kraft mit Geschmeidigkeit.</p>
              </div>
              {/* Small Cards */}
              <div className="md:col-span-2 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                ...
                <h3 className="text-label-lg uppercase tracking-widest text-primary-container mb-2">Flexibility</h3>
                <p className="text-on-surface-variant text-sm">Mobilitätssteigerung durch dynamisches Dehnen.</p>
              </div>
              <div className="md:col-span-2 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                <span className="material-symbols-outlined text-primary-container text-3xl mb-4">air</span>
                <h3 className="text-label-lg uppercase tracking-widest text-primary-container mb-2">Breathing</h3>
                <p className="text-on-surface-variant text-sm">Die bewusste Atmung als Taktgeber für jede Bewegung.</p>
              </div>
              <div className="md:col-span-2 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                <span className="material-symbols-outlined text-primary-container text-3xl mb-4">balance</span>
                <h3 className="text-label-lg uppercase tracking-widest text-primary-container mb-2">Balance</h3>
                <p className="text-on-surface-variant text-sm">Mentale und physische Ausgeglichenheit finden.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute bottom-6 right-6 bg-white/80 backdrop-blur-md p-6 rounded-xl border border-surface-container-high max-w-xs shadow-lg">
                <p className="text-primary-container font-lexend italic font-semibold text-sm leading-relaxed">&quot;Pilates ist die Kunst der bewussten Kontrolle über den eigenen Körper.&quot;</p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-on-surface-variant text-body-lg leading-relaxed">
                ...
                <div className="bg-surface-container-low p-8 rounded-xl border-l-4 border-secondary-container italic font-medium text-primary-container text-body-md">
                  &quot;Wir laden dich ein, Pilates nicht nur als Workout, sondern als ganzheitliche Methode zu erfahren, die Kraft, Beweglichkeit und mentale Fokus vereint.&quot;
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-10 items-center bg-white p-6 rounded-2xl border border-surface-container-high">
            <div className="w-48 h-48 rounded-full overflow-hidden flex-shrink-0 border-4 border-secondary-container">
              ...
              <img
                ...
                alt="Professional portrait of trainer Bettina Wredenhagen, smiling, dressed in high-quality sports gear, natural studio lighting"
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-on-surface-variant text-body-md mb-6 max-w-xl">
                &quot;Meine Leidenschaft ist es, Menschen dabei zu unterstützen, ihre eigene Mitte zu finden. Mit einer Kombination aus Pilates und BodyART begleite ich euch auf dem Weg zu mehr Kraft und innerer Ruhe.&quot;
              </p>
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                <span className="px-4 py-2 bg-surface-container text-on-surface rounded-full text-label-sm">Zertifizierte Pilates-Trainerin</span>
                <span className="px-4 py-2 bg-surface-container text-on-surface rounded-full text-label-sm">BodyART Instructor</span>
              </div>
            </div>
          </div>
        </section>
