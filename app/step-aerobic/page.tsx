  ...
  return (
    <div className="bg-background font-body-md text-on-background">
      ...
      <BaseNav
        logoUrl={logoUrl}
        clubName="Hünstetten"
        departmentLabel="Step-Aerobic"
        navItems={STEP_AEROBIC_NAV}
      ...
      <main className="pt-20">
        ...
        <section className="relative h-[716px] min-h-[500px] flex items-center overflow-hidden">
          <div className="absolute inset-0">
            ...
            <img
              ...
              alt="Group doing energetic step aerobics on platforms in a bright fitness studio"
          ...
          <div className="relative z-20 max-w-[1200px] mx-auto px-6 w-full">
            <div className="max-w-2xl text-white">
              <span className="inline-block px-4 py-1 bg-secondary-container text-on-secondary-fixed rounded-full text-label-lg mb-6">STEP BY STEP</span>
              <h1 className="text-display-lg font-display-lg mb-4 text-white">Step-Aerobic</h1>
              <p className="text-body-lg mb-8 opacity-90">Gelenkschonendes Herz-Kreislauf-Training mit Choreographie und Rhythmus. Kondition, Koordination und Spaß – alles in einer Stunde.</p>
          ...
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-8 border border-surface-container-high rounded-xl shadow-sm flex items-start gap-4 transition-all hover:shadow-md">
              ...
              <div>
                ...
                <p className="text-on-surface-variant font-body-md">Mittwochs, 20:00 – 21:00 Uhr</p>
              </div>
            </div>
            <div className="bg-white p-8 border border-surface-container-high rounded-xl shadow-sm flex items-start gap-4 transition-all hover:shadow-md">
            ...
            <div className="bg-white p-8 border border-surface-container-high rounded-xl shadow-sm flex items-start gap-4 transition-all hover:shadow-md">
              ...
              <div>
                ...
                <p className="text-on-surface-variant font-body-md">Sportkleidung, Hallenschuhe, Getränk</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-headline-lg font-headline-lg text-primary-container mb-6">Tanzen, Schwitzen, Strahlen</h2>
            ...
            <div className="mt-8 grid grid-cols-2 gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-label-lg">Mittleres Niveau</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                <span className="font-label-lg">Anfänger willkommen</span>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
              ...
              <div className="md:col-span-3 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                ...
                <h3 className="text-headline-md mb-4">Herz-Kreislauf-Training</h3>
                <p className="text-on-surface-variant">Aerobisches Ausdauertraining auf dem Step – gelenkschonend, effektiv und nachhaltig für Kondition und Herzgesundheit.</p>
              </div>
              {/* Choreographie */}
              <div className="md:col-span-3 bg-primary-container text-white p-8 rounded-xl transition-transform hover:-translate-y-1">
                ...
                <h3 className="text-headline-md mb-4">Choreographie &amp; Rhythmus</h3>
                <p className="opacity-80">Drei Choreographien pro Stunde – am Ende werden sie zusammengeführt. Tanzen und trainieren in einem, mit Musik und guter Stimmung.</p>
              </div>
              {/* Small Cards */}
              <div className="md:col-span-2 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                <span className="material-symbols-outlined text-primary-container text-3xl mb-4">directions_run</span>
                <h3 className="text-label-lg uppercase tracking-widest text-primary-container mb-2">Beine &amp; Gesäß</h3>
                <p className="text-on-surface-variant text-sm">Das Auf- und Absteigen kräftigt gezielt Bein- und Gesäßmuskulatur.</p>
              </div>
              <div className="md:col-span-2 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                ...
                <p className="text-on-surface-variant text-sm">Komplexe Bewegungsabfolgen schulen Koordination und Reaktionsvermögen.</p>
              </div>
              <div className="md:col-span-2 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                <span className="material-symbols-outlined text-primary-container text-3xl mb-4">bolt</span>
                <h3 className="text-label-lg uppercase tracking-widest text-primary-container mb-2">Rumpfstabilität</h3>
                <p className="text-on-surface-variant text-sm">Schnelle Richtungswechsel aktivieren und stabilisieren die gesamte Rückenmuskulatur.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute bottom-6 right-6 bg-white/80 backdrop-blur-md p-6 rounded-xl border border-surface-container-high max-w-xs shadow-lg">
                <p className="text-primary-container font-lexend italic font-semibold text-sm leading-relaxed">&quot;Step by Step – jede Choreographie macht dich stärker, koordinierter und glücklicher.&quot;</p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-on-surface-variant text-body-lg leading-relaxed">
                ...
                <div className="bg-surface-container-low p-8 rounded-xl border-l-4 border-secondary-container italic font-medium text-primary-container text-body-md">
                  &quot;Schnupper einfach rein – die Gruppe und Bettina freuen sich auf dich!&quot;
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-10 items-center bg-white p-6 rounded-2xl border border-surface-container-high">
            <div className="w-48 h-48 rounded-full overflow-hidden flex-shrink-0 border-4 border-secondary-container">
              ...
              <img
                ...
                alt="Porträt von Trainerin Bettina Wredenhagen"
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-headline-lg font-headline-lg text-primary-container mt-2 mb-4">Bettina Wredenhagen</h2>
              <p className="text-on-surface-variant text-body-md mb-6 max-w-xl">
                &quot;Step-Aerobic ist meine Leidenschaft – die Kombination aus Musik, Bewegung und Gemeinschaft macht jede Stunde besonders. Ich freue mich über jeden, der einfach mal reinschaut!&quot;
              </p>
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                <span className="px-4 py-2 bg-surface-container text-on-surface rounded-full text-label-sm">Step-Aerobic</span>
                <span className="px-4 py-2 bg-surface-container text-on-surface rounded-full text-label-sm">Ausdauer &amp; Choreographie</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-primary-container text-white relative overflow-hidden">
          ...
          <div className="max-w-[800px] mx-auto px-6 text-center relative z-10">
            <h2 className="text-headline-lg mb-6">Bereit für deinen ersten Step?</h2>
            <p className="text-on-primary-container text-body-lg mb-8">
              Mittwochs um 20 Uhr steht der Step bereit. Melde dich kurz bei Bettina an – damit sie die Stunde optimal auf dich abstimmen kann.
            </p>
