        ...
        <section className="relative h-[870px] flex items-center overflow-hidden vanguard-gradient">
          ...
          <div className="container mx-auto px-8 relative z-10">
            <div className="max-w-4xl">
              <span className="inline-block bg-secondary-container text-on-secondary-container font-headline font-black italic uppercase px-4 py-1 tracking-widest mb-6 kinetic-slant">
                SG HÜNSTETTEN PARTNERSHIP
              </span>
              <h1 className="text-white font-headline font-black italic uppercase text-6xl md:text-8xl leading-[0.9] tracking-tighter mb-8">
              ...
              <div className="mt-12 flex flex-wrap gap-6">
                <button className="bg-secondary-container text-on-secondary-container font-headline font-black italic uppercase px-10 py-4 rounded-xl text-lg shadow-2xl hover:scale-105 transition-transform">
                  JETZT PARTNER WERDEN
                </button>
                <button className="border-2 border-white/30 text-white font-headline font-bold italic uppercase px-10 py-4 rounded-xl text-lg backdrop-blur-sm hover:bg-white/10 transition-colors">
                  UNSERE STORY
                </button>
              </div>
            </div>
