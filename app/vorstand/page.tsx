      ...
      <main className="pt-20">
        ...
        <section className="relative h-[819px] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 px-8 md:px-16 lg:px-24 max-w-5xl">
            <span className="inline-block bg-secondary-container text-on-secondary-container px-4 py-1 rounded-full font-label text-xs font-bold uppercase tracking-widest mb-6 kinetic-slant">
              80 YEARS OF EXCELLENCE
            </span>
            <h1 className="font-headline font-black italic text-5xl md:text-7xl text-white leading-[0.9] tracking-tight mb-6">
        ...
        <section className="py-24 px-8 md:px-16 lg:px-24 bg-surface">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              <h2 className="font-headline font-black italic text-4xl md:text-5xl text-primary tracking-tight uppercase">
                Der Vorstand
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            {BOARD_MEMBERS.map(({ name, role, img }) => (
              <div key={name} className="group">
                ...
                <h3 className="font-headline font-bold text-xl italic text-primary">{name}</h3>
        ...
        <section className="py-24 px-8 md:px-16 lg:px-24 bg-surface-container-low">
          <div className="text-center mb-16">
            ...
            <h2 className="font-headline font-black italic text-4xl md:text-5xl text-primary tracking-tight uppercase">Unsere Abteilungsleiter</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10">
            {DEPT_LEADERS.map(({ name, dept, icon }) => (
              <div key={name} className="bg-white p-6 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-outline-variant/10 group">
                ...
                <h3 className="font-headline font-bold text-lg italic text-primary mb-1">{name}</h3>
        ...
        {/* Die Stillen Helfer */}
        <section className="py-24 px-8 md:px-16 lg:px-24 bg-primary text-white overflow-hidden relative">
          <div className="absolute top-0 right-0 opacity-10 font-headline font-black italic text-[15rem] leading-none select-none kinetic-slant pointer-events-none translate-x-20">
            HEROES
          </div>
          <div className="relative z-10">
            <div className="max-w-3xl mb-16">
              <h2 className="font-headline font-black italic text-4xl md:text-5xl text-secondary-container tracking-tight uppercase mb-6">Die Stillen Helfer</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors">
                ...
                <h3 className="font-headline font-bold text-2xl italic mb-2">Monika Lang</h3>
              ...
              <div className="bg-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors">
                ...
                <h3 className="font-headline font-bold text-2xl italic mb-2">Dieter Fuchs</h3>
              ...
              <div className="bg-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors">
                ...
                <h3 className="font-headline font-bold text-2xl italic mb-2">Erik Baum</h3>
        ...
        <section id="join" className="py-24 px-8 md:px-16 lg:px-24">
          <div className="max-w-6xl mx-auto rounded-[3rem] overflow-hidden bg-surface-container-lowest shadow-2xl flex flex-col md:flex-row border border-outline-variant/10">
            ...
            <div className="md:w-1/2 p-12 md:p-20 flex flex-col justify-center">
              <h2 className="font-headline font-black italic text-4xl md:text-5xl text-primary tracking-tight uppercase mb-6 leading-none">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-secondary-container text-on-secondary-container px-8 py-4 rounded-xl font-headline font-black italic uppercase tracking-wider shadow-lg hover:shadow-xl transition-all hover:scale-105 active:scale-95">
                  Jetzt Kontaktieren
                </button>
                <button className="bg-primary-container text-white px-8 py-4 rounded-xl font-headline font-black italic uppercase tracking-wider shadow-lg hover:shadow-xl transition-all hover:scale-105 active:scale-95">
                  Offene Stellen
                </button>
              </div>
            </div>
