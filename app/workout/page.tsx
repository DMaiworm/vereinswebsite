  ...
  return (
    <div className="bg-background font-body-md text-on-background">
      ...
      <BaseNav
        logoUrl={logoUrl}
        clubName="Hünstetten"
        departmentLabel="Workout"
        navItems={WORKOUT_NAV}
      ...
      <main className="pt-20">
        ...
        <section className="relative h-[716px] min-h-[500px] flex items-center overflow-hidden">
          <div className="absolute inset-0">
            ...
            <img
              ...
              alt="Person doing bodyweight workout exercises in a gym, motivated and energetic"
          ...
          <div className="relative z-20 max-w-[1200px] mx-auto px-6 w-full">
            <div className="max-w-2xl text-white">
              <span className="inline-block px-4 py-1 bg-secondary-container text-on-secondary-fixed rounded-full text-label-lg mb-6">AUSPOWERN &amp; SPASS HABEN</span>
              <h1 className="text-display-lg font-display-lg mb-4 text-white">Workout</h1>
              <p className="text-body-lg mb-8 opacity-90">Ausdauer, Kraft und gute Musik – alles mit dem eigenen Körpergewicht. Für alle, die Lust auf Bewegung haben, egal wie alt oder fit.</p>
          ...
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-8 border border-surface-container-high rounded-xl shadow-sm flex items-start gap-4 transition-all hover:shadow-md">
              ...
              <div>
                ...
                <p className="text-on-surface-variant font-body-md">Dienstags, 19:00 – 20:00 Uhr</p>
              </div>
            </div>
            <div className="bg-white p-8 border border-surface-container-high rounded-xl shadow-sm flex items-start gap-4 transition-all hover:shadow-md">
            ...
            <div className="bg-white p-8 border border-surface-container-high rounded-xl shadow-sm flex items-start gap-4 transition-all hover:shadow-md">
              ...
              <div>
                ...
                <p className="text-on-surface-variant font-body-md">Sportkleidung, Handtuch, Getränk</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-headline-lg font-headline-lg text-primary-container mb-6">Gemeinsam auspowern – mit Spaß</h2>
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
              ...
              <div className="md:col-span-3 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                ...
                <h3 className="text-headline-md mb-4">Kraft mit Körpergewicht</h3>
                <p className="text-on-surface-variant">Alle Übungen nutzen das eigene Körpergewicht – kein Equipment, kein Schnickschnack. Effektiv, funktional und überall umsetzbar.</p>
              </div>
              {/* Ausdauer */}
              <div className="md:col-span-3 bg-primary-container text-white p-8 rounded-xl transition-transform hover:-translate-y-1">
                ...
                <h3 className="text-headline-md mb-4">Ausdauer &amp; Kondition</h3>
                <p className="opacity-80">60 Minuten Bewegung zur motivierenden Musik trainieren Herz-Kreislauf-System und Grundlagenausdauer nachhaltig.</p>
              </div>
              {/* Small Cards */}
              <div className="md:col-span-2 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                ...
                <p className="text-on-surface-variant text-sm">Die Gruppe motiviert – gemeinsam kommt man weiter als alleine.</p>
              </div>
              <div className="md:col-span-2 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                <span className="material-symbols-outlined text-primary-container text-3xl mb-4">music_note</span>
                <h3 className="text-label-lg uppercase tracking-widest text-primary-container mb-2">Musik</h3>
                <p className="text-on-surface-variant text-sm">Motivierende Beats halten das Tempo hoch und machen jede Einheit zum Erlebnis.</p>
              </div>
              <div className="md:col-span-2 bg-white p-8 rounded-xl border border-surface-container-high transition-transform hover:-translate-y-1">
                <span className="material-symbols-outlined text-primary-container text-3xl mb-4">emoji_people</span>
                <h3 className="text-label-lg uppercase tracking-widest text-primary-container mb-2">Für alle</h3>
                <p className="text-on-surface-variant text-sm">Egal wie fit – Irina passt die Übungen an, damit jeder mitkommt.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute bottom-6 right-6 bg-white/80 backdrop-blur-md p-6 rounded-xl border border-surface-container-high max-w-xs shadow-lg">
                <p className="text-primary-container font-lexend italic font-semibold text-sm leading-relaxed">&quot;Am Ende geht es darum, dass du mit Spaß dich bewegt hast!&quot;</p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-on-surface-variant text-body-lg leading-relaxed">
                ...
                <div className="bg-surface-container-low p-8 rounded-xl border-l-4 border-secondary-container italic font-medium text-primary-container text-body-md">
                  &quot;Schau doch einfach mal zu einem Probetraining vorbei – meld dich kurz vorab und schon kann es losgehen!&quot;
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-10 items-center bg-white p-6 rounded-2xl border border-surface-container-high">
            <div className="w-48 h-48 rounded-full overflow-hidden flex-shrink-0 border-4 border-secondary-container">
              ...
              <img
                ...
                alt="Porträt von Trainerin Irina Djurganina"
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-headline-lg font-headline-lg text-primary-container mt-2 mb-4">Irina Djurganina</h2>
              <p className="text-on-surface-variant text-body-md mb-6 max-w-xl">
                &quot;Mir ist wichtig, dass sich jeder in meinem Kurs wohlfühlt und mit einem guten Gefühl nach Hause geht. Spaß an der Bewegung steht für mich immer an erster Stelle – der Rest kommt von alleine.&quot;
              </p>
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                <span className="px-4 py-2 bg-surface-container text-on-surface rounded-full text-label-sm">Bodyweight Training</span>
                <span className="px-4 py-2 bg-surface-container text-on-surface rounded-full text-label-sm">Kraft &amp; Ausdauer</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-primary-container text-white relative overflow-hidden">
          ...
          <div className="max-w-[800px] mx-auto px-6 text-center relative z-10">
            <h2 className="text-headline-lg mb-6">Bereit für dein erstes Workout?</h2>
            <p className="text-on-primary-container text-body-lg mb-8">
              Dienstags ab 19 Uhr. Melde dich kurz bei Irina mit deinem Wunschtermin – und dann geht es los!
            </p>
