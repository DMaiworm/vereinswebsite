...
const achtsamkeitTwConfig = JSON.stringify({
  darkMode: 'class',
...
export default function AchtsamkeitLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: ACHTSAMKEIT_OVERRIDES }} />
      <script dangerouslySetInnerHTML={{
        __html: `tailwind={config:${achtsamkeitTwConfig}};document.write('<scr'+'ipt src="https://cdn.tailwindcss.com?plugins=forms,container-queries"><\\/scr'+'ipt>');`,
      }} />
      {children}
    </>
  )
