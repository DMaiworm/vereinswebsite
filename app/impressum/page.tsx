      ...
      <main className="pt-20">
        ...
        <section className="relative h-[400px] flex items-center justify-center overflow-hidden bg-primary">
          ...
          <div className="relative z-10 text-center px-4">
            <div className="inline-block bg-yellow-400 text-primary font-headline font-black italic px-4 py-1 mb-4 vanguard-slant text-sm tracking-widest uppercase">Official Compliance</div>
            <h1 className="text-5xl md:text-7xl font-headline font-black italic text-white tracking-tighter uppercase leading-none">
        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-7 bg-surface-container-lowest rounded-3xl p-10 shadow-lg border-l-8 border-primary relative overflow-hidden">
              ...
              <h2 className="text-3xl font-headline font-black italic text-primary mb-8 uppercase tracking-tight">Impressum</h2>
            ...
            {/* Datenschutz */}
            <div id="datenschutz" className="md:col-span-5 bg-primary-container text-white rounded-3xl p-10 shadow-2xl relative vanguard-slant transform-none md:rotate-1">
              <h2 className="text-3xl font-headline font-black italic text-yellow-400 mb-6 uppercase tracking-tight">Datenschutz</h2>
              ...
              <button className="w-full bg-yellow-400 text-primary font-headline font-black italic py-4 rounded-xl hover:bg-white transition-colors uppercase tracking-widest">
            ...
            <div className="md:col-span-12 bg-surface-container-low rounded-3xl p-10 border-r-8 border-primary shadow-lg relative">
              <div className="flex flex-col md:flex-row gap-10 items-center">
                <div className="w-full md:w-2/3">
                  <h2 className="text-3xl font-headline font-black italic text-primary mb-6 uppercase tracking-tight">Kindeswohl-Kodex</h2>
                ...
                <div className="w-full md:w-1/3 bg-primary rounded-2xl p-8 text-center text-white vanguard-slant">
                  <span className="material-symbols-outlined text-yellow-400 text-6xl mb-4">favorite</span>
                  <p className="font-headline font-black italic uppercase text-lg leading-tight">Unsere Verantwortung,<br />Ihre Sicherheit.</p>
                </div>
              </div>
            </div>
            ...
            <div id="satzung" className="md:col-span-12 lg:col-span-4 bg-surface-container-high rounded-3xl p-8 flex flex-col justify-between border-t-8 border-yellow-400 shadow-lg">
              <div>
                <h2 className="text-2xl font-headline font-black italic text-primary mb-4 uppercase tracking-tight">Unsere Satzung</h2>
            ...
            <div className="md:col-span-12 lg:col-span-8 bg-surface-container-high rounded-3xl p-8 border-t-8 border-primary shadow-lg">
              <h2 className="text-2xl font-headline font-black italic text-primary mb-6 uppercase tracking-tight">Download-Bereich</h2>
            ...
            <div id="vorstand" className="md:col-span-12 bg-surface-container-lowest rounded-3xl p-10 shadow-lg">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 gap-4">
                <h2 className="text-3xl font-headline font-black italic text-primary uppercase tracking-tight">Der Vorstand</h2>
